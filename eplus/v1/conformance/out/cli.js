 ...
 *   npx @random-knights/eplus-conformance
 *
 *   # a local copy, or any other implementation's document
 *   npx @random-knights/eplus-conformance ./some-health-score.json
 *   npx @random-knights/eplus-conformance https://example.test/health-score.json
 *
 *   # promote every standard requirement that is currently a warning into a
 *   # failure. This is the 1.0.0 gate.
 *   npx @random-knights/eplus-conformance --strict
 *
